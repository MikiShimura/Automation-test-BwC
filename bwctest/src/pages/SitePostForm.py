...
class SitePostForm(SitePostFormLocators):
    ...
    def choose_site_category(self, category):
        if category == "Culture":
    ...
    def choose_site_ages(self, ages):
    ...
    def input_site_price(self, price):
